...
class SPAS:
    ...
    def instance_generator_no_tie(self):
        ...
        for student in self.sp:
            ...
            for i in range(length):
                ...
                projects_copy.remove(
                    p)  # I did this to avoid picking the same project 2x. This could also be achieved by shuffling and popping?
        ...
        self.lp = {'l' + str(i): [0, [], [], 0, 0] for i in
                   range(1, self.lecturers + 1)}  # we assign l1:[p1], l2:[p2], ..., l30:[p30]
        ...
        for lecturer in self.lp:
            ...
            for i in range(number_of_projects):
                ...
                self.lp[lecturer][2].extend(
                    self.plc[p][2])  # keep track of students who have chosen this project for the lecturer
        ...
        for lecturer in self.lp:
            ...
            random.shuffle(
                self.lp[lecturer][2])  # this line shuffles the final preference list for each lecturer. Hence ordered!
            self.lp[lecturer][0] = random.randint(self.lp[lecturer][3],
                                                  self.lp[lecturer][4])  # capacity for each lecturer
        ...
        if __name__ == '__main__':
            with open(filename, 'w') as I:
                ...
                for n in range(1, self.students + 1):
                    ...
                    sliced = [p[1:] for p in
                              preference]  # this only grabs the project index, e.g., p20 becomes 20 and p100 becomes 100
                    I.write(str(n) + ' ')
                ...
                for k in range(1, self.lecturers + 1):
                    ...
                    sliced = [s[1:] for s in
                              preference]  # this only grabs the student index, e.g., s20 becomes 20 and s100 becomes 100
